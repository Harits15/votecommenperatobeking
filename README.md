...
- Pemilih mengisi email dan admin dapat melihat daftar email yang sudah voting
...
- Data email pemilih disimpan pada path `voters`. Untuk demo, rules harus mengizinkan query `voters` dengan `orderByChild: "email"`; untuk produksi, gunakan Firebase Authentication atau OTP email karena input email saja bukan verifikasi identitas.
